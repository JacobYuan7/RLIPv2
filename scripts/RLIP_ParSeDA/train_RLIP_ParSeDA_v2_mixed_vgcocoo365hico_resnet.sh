...
python -m torch.distributed.launch --nproc_per_node=8 --nnodes=$WORLD_SIZE --node_rank=$RANK \
    ...
    --pretrained /Path/To/params/r50_cocoo365_lr141_dp0_mqs_lft_dab_deformable_detr_plus_iterative_bbox_refinement_36eps_converted.pth \
    --output_dir /Path/To/logs/RLIP_PDA_v2_VGCOCOO365HICO_RQL_LSE_RPL_40e \
    ...
    --dataset_file vg_coco2017_o365_hico \
