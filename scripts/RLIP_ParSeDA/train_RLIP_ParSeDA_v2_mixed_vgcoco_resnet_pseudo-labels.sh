...
python -m torch.distributed.launch --nproc_per_node=2 --nnodes=$WORLD_SIZE --node_rank=$RANK \
    ...
    --pretrained /mnt/data-nas/peizhi/params/r50_dab_deformable_detr_plus_iterative_bbox_refinement-checkpoint_converted.pth \
    --output_dir /mnt/data-nas/peizhi/logs/RLIP_PDA_v2_VGCOCO_pseudo-label_BLIP_Nu10_thr05_RQL_LSE_RPL_20e \
    --vg_path /mnt/data-nas/peizhi/data/VG \
    --coco_path /mnt/data-nas/peizhi/data/coco2017 \
    --coco_rel_anno_file /mnt/data-nas/peizhi/data/coco2017/annotations/RLIPv2_train2017_pseudo-labels_SceneGraph_model_large_caption_nucleus10_thre20.json \
    --vg_rel_anno_file /mnt/data-nas/peizhi/data/VG/annotations/scene_graphs_preprocessv1.json \
