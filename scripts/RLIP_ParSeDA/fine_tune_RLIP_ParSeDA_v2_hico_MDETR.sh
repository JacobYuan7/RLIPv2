...
python -m torch.distributed.launch --nproc_per_node=4 --use_env main.py \
    --pretrained /Path/To/logs/RLIP_PDA_v2_RQL_LSE_RPL_COCO_50e_MDETR2aux_L1/checkpoint0049.pth \
    --output_dir /Path/To/logs/RLIP_PDA_v2_HICO_RQL_LSE_RPL_COCO_50e_MDETR2aux_L1_20e \
    --dataset_file hico \
