...
python -m torch.distributed.launch --nproc_per_node=8 --nnodes=$WORLD_SIZE --node_rank=$RANK \
    ...
    --pretrained /Path/To/params/swin_tiny_cocoo365_drop_path0.2_dp0_mqs_lft_dab_deformable_detr_plus_iterative_bbox_refinement_36eps_converted.pth \
    --output_dir /Path/To/logs/RLIP_PDA_v2_SwinT_VGCOO365_BLIP_Nu10_thr20_RQL_LSE_RPL_20e \
