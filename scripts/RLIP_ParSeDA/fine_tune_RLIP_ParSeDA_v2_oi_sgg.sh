...
python -m torch.distributed.launch --nproc_per_node=4 --use_env main.py \
    --pretrained /Path/To/logs/RLIP_PDA_v2_VGCOO365_COO365det_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
    --output_dir /Path/To/logs/RLIP_PDA_v2_OISGGtrain_R50_VGCOO365_RQL_LSE_RPL_20e_L1_20e \
    --dataset_file oi_sgg \
    ...
    # (only initialize backbone)
    # --output_dir /Path/To/logs/RLIP_PDA_v2_OISGGtrain_backboneInit_L1_20e \
    # (COCOdet)
    # --pretrained /Path/To/params/r50_dab_deformable_detr_plus_iterative_bbox_refinement-checkpoint_converted.pth \
    # --output_dir /Path/To/logs/RLIP_PDA_v2_OISGGtrain_COCOdet_RQL_LSE_RPL_20e_L1_20e \
    # VG
    # --pretrained /Path/To/logs/RLIP_PDA_v2_verbtgtv5_RQL_LSE_RPL_COCO_20e_GLIP2aux_L1/checkpoint0019.pth \
    # --output_dir /Path/To/logs/RLIP_PDA_v2_OISGGtrain_VG_RQL_LSE_RPL_COCO_20e_L1_20e \
    # VG+COCO
    # --pretrained /Path/To/logs/RLIP_PDA_v2_VGCOCO_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
    # --output_dir /Path/To/logs/RLIP_PDA_v2_OISGGtrain_VGCOCO_RQL_LSE_RPL_20e_L1_20e \
