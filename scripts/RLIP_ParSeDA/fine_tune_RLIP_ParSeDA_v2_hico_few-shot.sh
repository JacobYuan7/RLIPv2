...
python -m torch.distributed.launch --nproc_per_node=4 --use_env main.py \
    ...
    --output_dir /Path/To/logs/RLIP_PDA_v2_HICO_R50_VGCOO365_COO365det_20e_L1_20e_few10 \
    --dataset_file hico \
    ...
    # Few-shot 1
    # --pretrained /Path/To/logs/RLIP_PDA_v2_VGCOO365_COO365det_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
    # --output_dir /Path/To/logs/RLIP_PDA_v2_HICO_R50_VGCOO365_COO365det_20e_L1_20e_few1 \
    # Few-shot 10
    # --pretrained /Path/To/logs/RLIP_PDA_v2_VGCOO365_COO365det_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
    # --output_dir /Path/To/logs/RLIP_PDA_v2_HICO_R50_VGCOO365_COO365det_20e_L1_20e_few10 \
