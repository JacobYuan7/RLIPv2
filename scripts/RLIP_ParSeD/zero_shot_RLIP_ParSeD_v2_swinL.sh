...
# Pay attention to the verb tgt vX!!!
python -m torch.distributed.launch --nproc_per_node=1 --use_env main.py \
        ...
        # VG
        # --pretrained /Path/To/logs/RLIP_PD_v2_SwinL_VG_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
        # VG + COCO
        # --pretrained /Path/To/logs/RLIP_PD_v2_SwinL_VGCOCO_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \
        # VG + COCO + O365
        # --pretrained /Path/To/logs/RLIP_PD_v2_SwinL_VGCOO365_BLIP_Nu10_thr20_RQL_LSE_RPL_20e/checkpoint0019.pth \