...
python -m torch.distributed.launch --nproc_per_node=8 --use_env main.py \
    ...
    --output_dir /Path/To/logs/RLIP_PD_v2_SwinL_VG_BLIP_Nu10_thr20_RQL_LSE_RPL_20e \
    --dataset_file vg \
    ...
    # --output_dir /Path/To/logs/RLIP_PDA_v2_SwinL_VG_BLIP_Nu10_thr20_RQL_LSE_RPL_20e \
