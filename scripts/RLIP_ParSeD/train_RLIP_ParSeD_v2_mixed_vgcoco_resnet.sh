...
python -m torch.distributed.launch --nproc_per_node=8 --use_env main.py \
    ...
    --output_dir /Path/To/logs/RLIP_PD_v2_VGCOCO_R50_BLIP1dense_thr20_VXAc_20e_GLIP2aux_L1 \
    ...
    --coco_rel_anno_file /Path/To/data/coco2017/annotations/RLIPv2_train2017_threshold20_Tagger2_Noi24_20e_Xattnmask_SceneGraph_BLIP1_nucleus10_BLIPdense_thre05.json \
