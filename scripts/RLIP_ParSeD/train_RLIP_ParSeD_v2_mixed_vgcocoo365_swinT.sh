...
python -m torch.distributed.launch --nproc_per_node=8 --use_env main.py \
    --pretrained /Path/To/params/swin_tiny_dp0_mqs_lft_deformable_detr_plus_iterative_bbox_refinement_plus_plus_two_stage_36eps_SepDDETRHOIv3_converted.pth \
    --output_dir /Path/To/logs/RLIP_PD_v2_VGCOCOO365_SwinT_BLIP_Nu10_thr20_20e_GLIP2aux_L1 \
