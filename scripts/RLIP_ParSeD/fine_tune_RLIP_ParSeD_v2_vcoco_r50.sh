...
python -m torch.distributed.launch --nproc_per_node=4 --use_env main.py \
    --pretrained /Path/To/logs/RLIP_PD_v2_RQL_LSE_RPL_COCO_20e_GLIP2aux_L1_VXAc/checkpoint0019.pth \
    --output_dir /Path/To/logs/RLIP_PD_v2_VCOCO_R50_VG_RQL_LSE_RPL_20e_L1_20e \
    --dataset_file vcoco \
    ...
    # --output_dir /Path/To/logs/RLIP_PD_v2_VCOCO_R50_VGCOCOO365_RQL_LSE_RPL_20e_L1_20e \
