...
# COCO train: 117266   5:39:34 (0.1737 s / it)
python generate_relations_using_verb_tagger.py \
        --param_path /Path/To/logs/RLIP_PD_v2_SwinL_Tagger2_Noi24_COCO_20e_GLIP2aux_L1/checkpoint0019.pth \
        --save_path /Path/To/data/coco2017/annotations/swin/RLIPv2_SwinL_trainval2017_threshold20_Tagger2_Noi24_20e_Xattnmask_SceneGraph_model_large_caption_nucleus10_thre05.json \
        --dataset_file coco \
